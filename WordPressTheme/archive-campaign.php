    ...
    <div class="campaign layout-campaign sub-page-fish">
        <div class="campaign__inner inner">
            <div class="campaign__tab genre-tab">
                <div class="campaign__tab genre-tab">
                    <a href="<?php echo get_post_type_archive_link('campaign'); ?>" class="genre-tab__item genre-tab__item--active">ALL</a>
                                ...
                                <div class="card__pc">
                                    ...
                                    <div class="card__box">
                                        ...
                                        <div class="card__btn">
                                            ...
                                            $campaign_title = urlencode(get_the_title());
                                            ?>
                                            <a href="<?php echo esc_url(add_query_arg('selected_campaign', $campaign_title, $contact_url)); ?>" class="button">
